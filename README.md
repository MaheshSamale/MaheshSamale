...
- Mobile: Android (Java, Kotlin), iOS (Swift, Storyboard)
...
<img alt="Storyboard" src="https://img.shields.io/badge/Storyboard-0D3B66?style=flat&logo=xcode&logoColor=white" />
<img alt="MySQL" src="https://img.shields.io/badge/MySQL-4479A1?style=flat&logo=mysql&logoColor=white" /> 
<img alt="SQL" src="https://img.shields.io/badge/SQL-316192?style=flat&logo=postgresql&logoColor=white" /> 
...
Website preview
- Live site: http://phpdhires.com/
- Preview (screenshot):  
  ![phpdhires preview](https://raw.githubusercontent.com/MaheshSamale/MaheshSamale/main/.github/images/phpdhires-preview.png)
  - If the image above doesn't render, upload a screenshot to `.github/images/phpdhires-preview.png` (or update the path) to show a thumbnail here.

Freelance work
- phpdhires.com — Built and launched the live website (full lifecycle: design → development → testing → deployment).
